...
Названия css анимаций нужно указывать с префиксом **`__U_`**. В этом случае в название подставится ID скрипта, что позволит избежать конфликтов с одноименными анимациями. TODO: пример и то что стало после конвертации
