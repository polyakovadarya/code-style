...
### [<img src="img/code-style/arrow_up.svg" alt="js" height="15px" width="20px"/> К оглавлению](#Содержание)
...
3. Eslint требует наличия конфигурационного файла [`.eslintrc.js`](./configs/.eslintrc.js). По умолчанию eslint ожидает размещение данного файла в корне проекта. Но пока что нужно указать к нему путь самостоятельно в файле настроек `VS CODE`:
```json
"eslint.options": {
...
- [Таблица типов](img/code-style/tableOfTypes.png)
---
### [<img src="img/code-style/arrow_up.svg" alt="js" height="15px" width="20px"/> К оглавлению](#Содержание)
