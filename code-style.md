...
* [Правила](#Правила)
  * [1. JavaScript](#1-JavaScript)
    ...
    * [1.4 ES6-стиль](#14-ES6-стиль)
      * [1.4.1 Объявление переменных](#141-Объявление-переменных)
      * [1.4.2 Инкременты и декременты](#142-Инкременты-и-декременты)
      * [1.4.3 Операторы сравнения и равенства](#142-Операторы-сравнения-и-равенства)
      * [1.4.4 Тернарные операторы](#144-Тернарные-операторы)
      * [1.4.5 Строки](#145-Строки)
      * [1.4.3 Map,ForEach,Filter,every/some](#143-Map,ForEach,Filter,every/some)
