...
* [Правила](#Правила)
  * [1. JavaScript](#1-JavaScript)
    ...
    * [1.3 Название функции должно отражать ее назначение](#1.3-Название-функции-должно-отражать-ее-назначение)
    * [1.4 ES6-стиль](#13-ES6-стиль)
      * [1.4.1 Объявление переменных](#131-Объявление-переменных)
      * [1.4.2 Инкременты и декременты](#132-Инкременты-и-декременты)
      * [1.4.3 Операторы сравнения и равенства](#132-Операторы-сравнения-и-равенства)
      * [1.4.4 Тернарные операторы](#134-Тернарные-операторы)
      * [1.4.5 Строки](#135-Строки)
      * [1.4.3 Map,ForEach,Filter,every/some](#133-Map,ForEach,Filter,every/some)
  * [2. Работа с графом](#2-Работа-с-графом)
    * [2.1 Шаг `init`. Инициализация](#2.1-Шаг-init-Инициализация)
    * [2.2 Шаг `render`. Рендеринг](#2.2-Шаг-render-Рендеринг)
    * [2.3 Шаг `start`. Начало](#2.3-Шаг-start-Начало)
    * [2.4 Шаг `continue`. Продолжение](#2.4-Шаг-continue-Продолжение)
    * [2.5 Шаг `deinit`. Окончание](#2.5-Шаг-deinit-Окончание)
...
num -= 1;
```
#### 1.4.3 Операторы сравнения и равенства
...
```
[<img src="img/right.svg" alt="js" height="10px" width="10px"/> К оглавлению](#Содержание)
### 1.4.3 `map,forEach,filter,every/some`
